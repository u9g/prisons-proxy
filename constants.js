...
module.exports = {
    ...
    minutes: 60 * 1000,
    MIDAS_CORNERS,
    midasCornerCommandConfirm: corner => `{"extra":[{"bold":true,"color":"gray","extra":[{"color":"white","text":"MIDAS"},{"text":"]"}],"text":"["},{"text":" You will be told in "},{"underlined":true,"color":"aqua","text":"10 minutes"},{"text":" when "},{"bold":true,"extra":[{"color":"green","text":"${MIDAS_CORNERS[corner]}"},{"text":" has "},{"color":"red","text":"respawned"}],"text":""}],"text":""}`,
    midasWillSpawnInCorner: (corner, inTime) => `{"extra":[{"bold":true,"color":"gray","extra":[{"color":"white","text":"MIDAS"},{"text":"]"}],"text":"["},{"text":" "},{"bold":true,"extra":[{"color":"green","text":"${MIDAS_CORNERS[corner]}"},{"text":" will respawn in "},{"underlined":true,"color":"aqua","text":"${inTime}"}],"text":""}],"text":""}`,
    midasSpawnedInCorner: corner => `{"extra":[{"bold":true,"color":"gray","extra":[{"color":"white","text":"MIDAS"},{"text":"]"}],"text":"["},{"text":" "},{"bold":true,"extra":[{"color":"green","text":"${MIDAS_CORNERS[corner]}"},{"text":" has "},{"color":"red","text":"respawned"}],"text":""}],"text":""}`
}